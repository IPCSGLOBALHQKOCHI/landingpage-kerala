      ...
      <div className="relative">
        ...
        <div className="w-full md:w-1/2 flex flex-col items-start relative">
          ...
          <img
            src={MainImage}
            alt="Tech World"
            className="absolute top-0 left-0 z-[100] opacity-100 mt-12 xl:mt-10 xl:ml-24 ml-32 sm:mt-14 sm:ml-14 md:mt-14 md:ml-20 w-40 sm:w-52 md:w-auto"
          />
        ...
        <button   onClick={() => document.getElementById("contactSection").scrollIntoView({ behavior: "smooth" })}
         className="absolute flex items-center space-x-4 pr-4 rounded-full py-[5px] pl-10 bg-yellow-400 text-black font-semibold text-lg mt-[530px] sm:mt-[560px] md:mt-[650px] lg:mt-[590px] xl:mt-[550px] ml-24 xl:ml-24 md:ml-20 sm:ml-16 lg:ml-24">
