...
import vectorlogo from "/assets/IPCS GLOBAL logo-01 (1) 3 (1).png"
...
<div className="container flex ml-20 w-[520px] h-[350px] items-center relative">
  {/* Form container */}
  <div
    className="text-white p-4 rounded-xl shadow-md w-full relative"
    style={{
      background:
          ...
          <div className="flex space-x-4">
            ...
            <div className="w-full">
              ...
              <Field
                ...
                id="course"
                name="course"
                className="w-full px-4 py-2 rounded text-gray-500 focus:outline-none"
              >
                <option value="" label="Select your course" />
