      ...
      <div className="max-w-screen-xl mx-auto px-4 py-6 flex flex-col lg:flex-row lg:justify-between lg:items-start gap-8">
        ...
        <div className="lg:w-2/4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-3 gap-4 text-center lg:text-left">
            {[
              { name: "Kochi", link: "#contactSection" },
              { name: "Calicut", link: "#contactSection" },
              { name: "Trivandrum", link: "#contactSection" },
              { name: "Attingal", link: "#contactSection" },
              { name: "Kollam", link: "#contactSection" },
              { name: "Kannur", link: "#contactSection" },
              { name: "Thrissur", link: "#contactSection" },
              { name: "Perinthalmanna", link: "#contactSection" },
              { name: "Kottayam", link: "#contactSection" },
              { name: "Pathanamthitta", link: "#contactSection" },
              { name: "Palakkad", link: "#contactSection" },
            ].map((location, index) => (
              <a
                key={index}
                href={location.link}
