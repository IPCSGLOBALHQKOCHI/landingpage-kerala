...
function Card({ bgImage, Image, title1, description }) {
  return (
    <div className="mt-10 sm:mt-14 xl:ml-8 md:ml-4 xl:mr-0 lg:ml-8 lg:mr-4 md:mr-3 sm:ml-10 sm:mr-10 mr-5 ml-5  gap-0   lg:gap-2 xl:gap-4 xl:w-[24rem] lg:w-[20rem]">
      <div
